...
Scenario 3: Aquele que eu tento cadastrar duas vacinas iguais 
    [Tags]    APIVacinas    Regressão    Negativo
    Given Que eu tento cadastrar uma nova vacina fora da validade
    then Valido Status code    422
...
Scenario 3: Aquele que eu tento cadastrar uma vacina sem nome
    [Tags]    APIVacinas    Regressão    Negativo
    Given Que eu tento cadastrar uma nova vacina sem nome
    then Valido Status code    422

Scenario 3: Aquele que eu tento cadastrar uma vacina sem fabricante
    [Tags]    APIVacinas    Regressão    Negativo
    Given Que eu tento cadastrar uma nova vacina sem fabricante
    then Valido Status code    422

Scenario 3: Aquele que eu tento cadastrar uma vacina sem lote
    [Tags]    APIVacinas    Regressão    Negativo
    Given Que eu tento cadastrar uma nova vacina sem lote
    then Valido Status code    422

Scenario 3: Aquele que eu tento cadastrar uma vacina com lote negativo
    [Tags]    APIVacinas    Regressão    Negativo
    Given Que eu tento cadastrar uma nova vacina com lote negativo
    then Valido Status code    422

Scenario 3: Aquele que eu tento cadastrar uma vacina sem validade
    [Tags]    APIVacinas    Regressão    Negativo
    Given Que eu tento cadastrar uma nova vacina sem validade
    then Valido Status code    422

Scenario 3: Aquele que eu tento cadastrar uma vacina sem intervalo entre doses
    [Tags]    APIVacinas    Regressão    
    Given Que eu tento cadastrar uma nova vacina sem intervalo entre doses
    then Valido Status code   422

Scenario 3: Aquele que eu tento cadastrar uma vacina com intervalo entre doses negativo
    [Tags]    APIVacinas    Regressão    Negativo
...
Scenario 4: Aquele que eu atualizo os dados de uma vacina e removo o nome 
    [Tags]    APIVacinas    Regressão
    Given Que eu tenha cadastrado uma nova vacina 
    and Que eu atualizo os dados da vacina e removo o nome
    then Valido Status code    422

Scenario 4: Aquele que eu atualizo os dados de uma vacina e removo o fabricante
    [Tags]    APIVacinas    Regressão
    Given Que eu tenha cadastrado uma nova vacina 
    and Que eu atualizo os dados da vacina e removo o fabricante 
    then Valido Status code    422

Scenario 4: Aquele que eu atualizo os dados de uma vacina e removo o lote
    [Tags]    APIVacinas    Regressão
    Given Que eu tenha cadastrado uma nova vacina 
    and Que eu atualizo os dados da vacina e removo o lote 
    then Valido Status code    422

Scenario 4: Aquele que eu atualizo os dados de uma vacina e passo um lote negativo 
    [Tags]    APIVacinas    Regressão
    Given Que eu tenha cadastrado uma nova vacina 
    and Que eu atualizo os dados da vacina e passo um lote negativo 
    then Valido Status code    422

Scenario 4: Aquele que eu atualizo os dados de uma vacina e removo a validade 
    [Tags]    APIVacinas    Regressão
    Given Que eu tenha cadastrado uma nova vacina 
    and Que eu atualizo os dados da vacina e removo a validade 
    then Valido Status code    422

Scenario 4: Aquele que eu atualizo os dados de uma vacina e informo uma validade vencina 
    [Tags]    APIVacinas    Regressão
    Given Que eu tenha cadastrado uma nova vacina 
    and Que eu atualizo os dados da vacina e inforo uma valdiade vencida
    then Valido Status code    422

Scenario 4: Aquele que eu atualizo os dados de uma vacina e removo a quantidade de doses 
    [Tags]    APIVacinas    Regressão
    Given Que eu tenha cadastrado uma nova vacina 
    and Que eu atualizo os dados da vacina e removo a quantidade de doses
    then Valido Status code    422

Scenario 4: Aquele que eu atualizo os dados de uma vacina e informo uma dose negativa
    [Tags]    APIVacinas    Regressão
    Given Que eu tenha cadastrado uma nova vacina 
    and Que eu atualizo os dados da vacina e passo uma dose negativa
    then Valido Status code    422

Scenario 4: Aquele que eu atualizo os dados de uma vacina e removo o intervalo entre dose
    [Tags]    APIVacinas    Regressão
    Given Que eu tenha cadastrado uma nova vacina 
    and Que eu atualizo os dados da vacina e removo o intervalo entre dose
    then Valido Status code    200

Scenario 4: Aquele que eu atualizo os dados de uma vacina e passo um intervalo entre doses negativo
    [Tags]    APIVacinas    Regressão
    Given Que eu tenha cadastrado uma nova vacina 
